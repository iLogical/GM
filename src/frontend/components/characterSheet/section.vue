<template>
  <div class="section" :style="style">
    <h5 @click="toggleExpanded" class="title">
      <div>{{title}}</div>
      <div v-if="canExpand">
        <div v-if="expanded"><minus-icon></minus-icon></div>
        <div v-else><plus-icon></plus-icon></div>
      </div>
    </h5>
...
<script>
import plusIcon from '../../../static/icons/SVG/plus.svg?inline'
import minusIcon from '../../../static/icons/SVG/minus.svg?inline'
export default {
  props: {
    title: {
      type: String,
